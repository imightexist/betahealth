...
public class betahealth extends JavaPlugin implements Listener, CommandExecutor {
    ...
    public void onPlayerJoin(PlayerJoinEvent p) {
        ...
        player.setResourcePack("https://www.dropbox.com/s/v9y2dzccexlu0tl/no%20hunger%201.17.5.zip?dl=1");
    }
    @EventHandler
    ...
    public void onFoodLevelChange(FoodLevelChangeEvent e) {
        ...
        //p.setHealthScale(20);
        if (e.getFoodLevel() > 7){
            /*if (h.getHealth() + (e.getFoodLevel() - 7)/2 > 10){
                h.setHealth(10);
                //p.setHealthScale(10);
            }else{
            ...
            h.setHealth(Math.min(20,h.getHealth() + (e.getFoodLevel() - 7)));
